 ...
 *
 * Then tell the tester to launch the app with:
 *   SMC_DEBUG=1 SMC_DEBUG_HOST=<your-ip>:<port> open /Applications/SteamMacClient.app
 *
...
console.log(`\x1b[33m[debug-server]\x1b[0m Tell tester to run:`);
console.log(`\x1b[36m  SMC_DEBUG=1 SMC_DEBUG_HOST=<your-ip>:${port} open /Applications/SteamMacClient.app\x1b[0m`);
